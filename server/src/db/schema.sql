...
-- Translation key for seeded games so their name follows the theme language;
-- user-created games leave this null and show their literal name.
ALTER TABLE games ADD COLUMN IF NOT EXISTS name_key TEXT;
